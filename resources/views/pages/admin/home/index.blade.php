                ...
                <div class="d-flex align-items-end row">
                    ...
                    <div class="col-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                            <img src="{{ asset('web_components/assets/img/illustrations/card-advance-sale.png') }}"
                ...
                <div class="card-body">
                    <ul class="p-0 m-0">
                        <li class="d-flex mb-4 pb-1">
                            <div class="me-3">
                                <img src="{{ asset('web_components/assets/img/products/iphone.png') }}" alt="User"
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="me-3">
                                <img src="{{ asset('web_components/assets/img/products/nike-air-jordan.png') }}"
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="me-3">
                                ...
                                <img src="{{ asset('web_components/assets/img/products/headphones.png') }}" alt="User"
                                    class="rounded" width="46" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="me-3">
                                ...
                                <img src="{{ asset('web_components/assets/img/products/apple-watch.png') }}"
                                    alt="User" class="rounded" width="46" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="me-3">
                                ...
                                <img src="{{ asset('web_components/assets/img/products/amazon-echo.png') }}"
                                    alt="User" class="rounded" width="46" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex">
                            <div class="me-3">
                                ...
                                <img src="{{ asset('web_components/assets/img/products/play-station.png') }}"
                                    alt="User" class="rounded" width="46" />
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
...
@push('scripts')
    <script>
        ...
        var App = {
            initialize: function() {
                App.showUserRegistrationGraph();
            },

            showUserRegistrationGraph: function() {
                ...
                revenueReportChartOptions = {
                    ...
                    series: [{
                            name: 'Earning',
                            data: [{{ implode(',', $userRegistrationGraphData['data']) }}]
                        },
                        // {
                        //     name: 'Expense',
                    ...
                    xaxis: {
                        categories: [{!! '\'' . implode("','", $userRegistrationGraphData['item']) . '\'' !!}],
                        labels: {
                            style: {
