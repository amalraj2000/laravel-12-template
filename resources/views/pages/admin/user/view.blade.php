    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
            ...
            <ul class="nav nav-pills flex-column flex-md-row mb-4">
                <li class="nav-item">
                    <a class="nav-link active" href={{route('admin.view-data',$userDetails->id)}}><i
                            class="ti ti-user-check ti-xs me-1"></i>Account</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('admin.view-notification',$userDetails->id)}}"><i
                            ...
                            <div class="timeline-event">
                                ...
                                <div class="d-flex">
                                    <a href="javascript:void(0)" class="me-3">
                                        ...
                                        <img src="{{ asset('web_components/assets/img/icons/misc/pdf.png') }}" alt="PDF image" width="15"
                                            class="me-2" />
                            ...
                            <div class="timeline-event">
                                ...
                                <div class="d-flex flex-wrap">
                                    <div class="avatar me-3">
                                        ...
                                        <img src="{{ asset('web_components/assets/img/avatars/3.png') }}" alt="Avatar"
                            ...
                            <div class="timeline-event">
                                ...
                                <div class="d-flex align-items-center avatar-group">
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        ...
                                        <img src="{{ asset('web_components/assets/img/avatars/5.png') }}" alt="Avatar"
                                            class="rounded-circle" />
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Marrie Patty">
                                        <img src="{{ asset('web_components/assets/img/avatars/12.png') }}" alt="Avatar"
                                            class="rounded-circle" />
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Jimmy Jackson">
                                        <img src="{{ asset('web_components/assets/img/avatars/9.png') }}" alt="Avatar"
                                            class="rounded-circle" />
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Kristine Gill">
                                        <img src="{{ asset('web_components/assets/img/avatars/6.png') }}" alt="Avatar"
                                            class="rounded-circle" />
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Nelson Wilson">
                                        <img src="{{ asset('web_components/assets/img/avatars/4.png') }}" alt="Avatar"
                                            class="rounded-circle" />
                                    </div>
                                </div>
                            </div>
