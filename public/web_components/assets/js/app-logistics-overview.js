...
$(function () {
  ...
  var dt_overview_table = $('.dt-route-vehicles');

  // On route vehicles DataTable
  if (dt_overview_table.length) {
    var dt_overview = dt_overview_table.DataTable({
      ajax: assetsPath + 'json/logistics-overview.json',
      columns: [
        { data: 'id' },
        { data: 'id' },
        { data: 'location' },
